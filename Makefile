...
dry-run:
	...
	@echo "=== k8s/github-actions-rbac ===" && cat k8s/github-actions-rbac.yaml
...
diff:
	...
	@cat k8s/github-actions-rbac.yaml | kubectl diff -f -
...
apply:
	...
	@cat k8s/github-actions-rbac.yaml | kubectl apply -f -
